...
export default defineConfig({
  ...
  plugins: [react()],
  build: {
    // [TRES-PAINEIS] Uma entrada por painel. O Vite gera um bundle para cada
    ...
    // (/painel-medico, /painel-admin e /painel-ubs). Custa duplicar o React,
    ...
    // São três produtos, com públicos e compradores diferentes.
    rollupOptions: {
      input: fileURLToPath(
