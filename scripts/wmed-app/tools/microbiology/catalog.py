...
# Expansion: distinct representative morphologies, same educational material pipeline.
parts['capsula-bacteriana']=('Cápsula bacteriana','#91b4c5','Camada externa polissacarídica; pode dificultar a fagocitose e contribuir para virulência.')
parts['tegumento']=('Tegumento','#c5a57e','Camada de proteínas entre o capsídeo e o envelope dos herpesvírus.')
parts['axostilo']=('Axóstilo','#cbb67b','Estrutura de microtúbulos que atravessa o trofozoíto de Trichomonas.')
parts['hidrogenossomos']=('Hidrogenossomos','#d08b69','Organelas metabólicas de Trichomonas; participam do metabolismo energético anaeróbio.')
add('pneumococcus','Streptococcus pneumoniae','bacterias','diplococcus','Diplococos Gram-positivos encapsulados. A forma em pares e a cápsula são destacadas; não identificam a espécie isoladamente.','Compare a cápsula externa com a parede de peptidoglicano.','capsula-bacteriana parede membrana citoplasma nucleoide ribossomos',[B,'https://www.cdc.gov/pneumococcal/hcp/clinical-overview/index.html'])
add('pseudomonas','Pseudomonas aeruginosa','bacterias','polar-rod','Bacilo Gram-negativo com flagelo polar. Representação didática do envoltório e da motilidade.','Localize o flagelo polar e a membrana externa.','externa parede membrana citoplasma nucleoide ribossomos flagelo',[B])
add('herpes','Herpes simplex','virus','herpes','Vírus envelopado com capsídeo icosaédrico, DNA dupla fita e tegumento.','Abra o envelope para distinguir tegumento e capsídeo.','envelope espiculas tegumento capsideo genoma',[V,'https://www.cdc.gov/std/treatment-guidelines/herpes.htm'])
add('hepatite-b','Vírus da hepatite B','virus','hbv','Partícula de Dane envelopada com nucleocapsídeo e DNA circular parcialmente dupla fita.','O genoma é circular, com uma fita incompleta representada em destaque.','envelope espiculas capsideo genoma',[V,'https://www.cdc.gov/hepatitis-b/hcp/clinical-care/index.html'])
add('histoplasma','Histoplasma capsulatum · levedura','fungos','histo','Forma leveduriforme com brotamento de base estreita. A fase filamentosa e o macrófago hospedeiro não estão representados.','Reconheça o broto pequeno ligado por base estreita.','parede membrana citoplasma nucleo vacuolo broto mitocondrias',['https://www.cdc.gov/histoplasmosis/hcp/clinical-overview/index.html'])
add('paracoccidioides','Paracoccidioides · levedura','fungos','para','Levedura com múltiplos brotamentos, em arranjo didático de roda de leme. Número e tamanho dos brotos variam.','Observe os brotos distribuídos ao redor da célula-mãe.','parede membrana citoplasma nucleo vacuolo broto mitocondrias',['https://www.cdc.gov/paracoccidioidomycosis/about/index.html'])
add('leishmania','Leishmania · promastigota','protozoarios','leish','Forma promastigota do vetor e de cultura, alongada com flagelo anterior livre. Não é o amastigota intracelular do humano.','Observe o cinetoplasto anterior e o flagelo livre.','membrana citoplasma nucleo cinetoplasto flagelo',['https://www.cdc.gov/dpdx/leishmaniasis/index.html'])
add('trichomonas','Trichomonas vaginalis · trofozoíto','protozoarios','tricho','Trofozoíto piriforme com quatro flagelos anteriores, flagelo recorrente, membrana ondulante curta e axóstilo. Não forma cistos.','Compare os flagelos livres, a membrana ondulante e o axóstilo.','membrana citoplasma nucleo flagelo ondulante axostilo hidrogenossomos',['https://www.cdc.gov/dpdx/trichomoniasis/index.html'])
