...
const PLANOS = {
  ...
  // 3ª versão (26/09), pedido do Dilson: aparelho de pressão aparecia duas
  // vezes na UBS; rio e café não combinam com ensino de medicina; câmera mais
  // longe (Iris em no máximo 1/4 do quadro, o ambiente domina).
  ubs3: { iris: false,
    imagem: `Brazilian public primary-care clinic (UBS) waiting room, late afternoon, wide shot from the far side of the room. A Brazilian man in his mid-50s, mixed-race (pardo), heavy-set, grey stubble, faded work shirt, doubled over on a plastic chair clutching his chest with one hand, sweating and grimacing; a single blood-pressure cuff is already wrapped around his other upper arm, and a Brazilian nursing technician in plain light-blue scrubs kneels beside him holding only the inflation bulb; his adult son stands over him, alarmed, hand on his shoulder. Other waiting patients in the foreground and background, some turning to look. Plastic chairs, tiled floor, flat fluorescent light mixed with warm window light. The people occupy the middle of a wide frame. ${FILME}`,
    video: 'Wide observational shot across the clinic waiting room: the man clutches his chest and breathes hard; the nursing technician squeezes the bulb of the one cuff already on his arm and watches the gauge; the son leans in, worried; patients in the foreground stand up and look. There is only one blood-pressure cuff in the scene; nobody brings another. Handheld, slightly shaky, no push-in, no zoom.',
    som: 'No clear dialogue, muffled Portuguese murmurs, the man breathing hard, the squeeze of the cuff bulb.' },
  anfiteatro: { iris: true, fala: "This one showed up on a real medical licensing exam. Most people get it wrong.",
    imagem: `${IRIS} She wears a deep teal (#265B5A) knit sweater over a white collared shirt. Very wide shot of an empty medical-school lecture theatre at night, seen from the back rows: tiered wooden seats in the foreground, a large blank projection screen and a blackboard with no writing at the front. She sits on the edge of the lecturer's desk, small in the frame (no more than a quarter of the height), in three-quarter profile, talking to a young resident sitting in the front row with his back to the camera. Only a few lamps on, pools of warm light, deep shadows. ${FILME}`,
    video: 'Static very wide shot from the back rows of an empty lecture theatre at night: she sits on the edge of the desk and talks to the resident in the front row, with a small shrug and a dry half-smile; he laughs quietly. She is small in the frame and never looks at the camera. A projector fan hums. No zoom, no push-in.' },
  posto: { iris: true, fala: "D. It's not just high blood pressure. Chest pain, breathless, confused: that's a hypertensive emergency.",
    imagem: `${IRIS} She wears a clean white doctor's coat over a deep teal (#265B5A) sweater, no stethoscope, no badge text. Very wide shot of a hospital emergency department nurses' station at 3 a.m., seen from across the ward: she stands at the counter, small in the frame (no more than a quarter of the height), in three-quarter profile, talking to two nurses in scrubs; monitors with abstract waveforms and no readable text, a curtained bay and an empty stretcher in the foreground, cool fluorescent light, a few warm desk lamps. ${FILME}`,
    video: 'Static very wide shot across the emergency department at night: at the nurses\' station she explains something to two nurses with a small hand gesture; one nods and writes. A nurse crosses the foreground. She is small in the frame and never looks at the camera. No zoom, no push-in.' },
  descanso: { iris: true, fala: "Real life, though? Chest pain that won't go away... you call for help. Right now.",
    imagem: `${IRIS} She wears a deep teal (#265B5A) knit sweater over a white collared shirt, a white coat hanging on the chair. Wide shot of a small hospital doctors' lounge at night, seen from the doorway: an old sofa, a kitchenette with a kettle, a window with rain, lockers. She sits at a small table in three-quarter profile, small in the frame (no more than a quarter of the height), talking to a colleague in scrubs sitting opposite with his back to the camera, both with paper cups of coffee. Warm lamp, cool light from the window. ${FILME}`,
    video: 'Static wide shot from the doorway of the doctors\' lounge at night: she talks to her colleague across the table, turns her paper cup, pauses, then says the line; he nods slowly. Rain on the window. She is small in the frame and never looks at the camera. No zoom, no push-in.' },
};
