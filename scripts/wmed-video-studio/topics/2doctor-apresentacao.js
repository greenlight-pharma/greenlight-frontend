...
(() => {
  ...
  const L = EN ? {
    ...
    novos: [['Innovation radar', 'Technologies under evaluation', 'shield'], ['Interpret a study', 'Absolute risk, relative risk and NNT', 'check'],
    ...
    novos: [['Radar de inovação', 'Tecnologias em avaliação', 'shield'], ['Interpretar um estudo', 'Risco absoluto, relativo e NNT', 'check'],
